...
void draw_objects()
{
  ...
  if (Draw_point){
	...
	case OBJECT_CUBE:Cubo.draw_point();break;
    default:break;
    }
  }
  ...
  if (Draw_line){
	...
	case OBJECT_CUBE:Cubo.draw_line();break;
    default:break;
    }
  }
  ...
  if (Draw_fill){
	...
	case OBJECT_CUBE:Cubo.draw_fill();break;
    default:break;
    }
  }
  ...
  if (Draw_chess){
	...
	case OBJECT_CUBE:Cubo.draw_chess();break;
    default:break;
    }
  }
}
